...
// Nom du site
define ("NOM_SITE", "$NOMSITE");//Le nom du site son rep sera nommer pareille
...
define("LANGUE_DEFAULTS","$LANG"); //la langue d'origine du site;
...
/**************Lien Php inCassable ******************/
//La racine du site
define ("REP_RACINE", $_SERVER['DOCUMENT_ROOT']."/".NOM_SITE."/");
...
define ("REP_MODULES" , REP_RACINE."module/"); //repertoire des modules
